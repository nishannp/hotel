...
.item-card:hover .card-img.loaded {
...
<div class="item-container">
    <div class="page-header">
        <h2 id="main-title">Store Items</h2>
...
<aside id="itemDrawer" class="form-drawer">
    ...
    <form id="itemForm" class="drawer-body" enctype="multipart/form-data">
        <input type="hidden" id="storeItemId" name="store_item_id">
        ...
        <div class="form-group">
            ...
            <input type="text" id="itemName" name="item_name" required placeholder="e.g., Bottled Water">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" id="itemPrice" name="item_price" step="0.01" required placeholder="e.g., 1.50">
        </div>
        <div class="form-group">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector('.content-header h1').textContent = 'Store Item Management';
    ...
    const StoreItemApp = {
        ...
        bindEvents() {
            ...
            this.elements.itemContent.addEventListener('click', (e) => {
        ...
        async loadData() {
            try {
                const [itemsRes, categoriesRes] = await Promise.all([
                    fetch('ajax/ajax_handler_store_items.php?action=fetchAll'),
        ...
        // Rendering Logic
        render() {
            this.elements.itemContent.innerHTML = '';
            ...
            if (shouldGroup) {
                ...
                sortedCategoryIds.forEach(categoryId => {
                    if (itemsByCategory[categoryId]) {
                        this.elements.itemContent.appendChild(this.createCategorySection(itemsByCategory[categoryId]));
                    }
                });
            } else {
                ...
                this.elements.itemContent.appendChild(grid);
            }
                ...
                <div class="item-card">
                    <div class="card-image-wrapper">
                         ...
                         <div class="card-actions">
                            <button class="edit-btn" data-id="${item.StoreItemID}" title="Edit"><span class="material-icons-outlined">edit</span></button>
                            <button class="delete-btn" data-id="${item.StoreItemID}" title="Delete"><span class="material-icons-outlined">delete</span></button>
                        </div>
                    </div>
        ...
        openDrawer(itemId = null) {
            ...
            if (itemId) {
                document.getElementById('drawerTitle').textContent = 'Edit Store Item';
                const item = this.state.items.find(i => i.StoreItemID == itemId);
                if (item) {
                    document.getElementById('storeItemId').value = item.StoreItemID;
        ...
        async handleFormSubmit(event) {
            ...
            formData.delete('item_image'); // Not needed as we use base64 data

            try {
                const response = await fetch('ajax/ajax_handler_store_items.php', { method: 'POST', body: formData });
        ...
        async handleDelete(id) {
            if (confirm('Are you sure you want to delete this item? This action cannot be undone.')) {
                try {
                    const response = await fetch('ajax/ajax_handler_store_items.php', {
                        method: 'POST',
        ...
        observeImages() {
            const images = this.elements.itemContent.querySelectorAll('img[data-src]');
