...
<div class="page-container">
    <div class="page-header">
        <h2 id="main-title">Menu Categories</h2>
...
<aside id="categoryDrawer" class="form-drawer">
    ...
    <form id="categoryForm" class="drawer-body">
        ...
        <div class="form-group">
            ...
            <input type="text" id="categoryName" name="category_name" required placeholder="e.g., Appetizers, Main Courses">
        </div>

        <div class="form-group">
            <label for="description">Description</label>
            <textarea id="description" name="description" rows="4" placeholder="A short description of the category..."></textarea>
        </div>
    </form>
...
<div id="confirmationModal" class="confirmation-modal">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <p id="confirmationMessage">Are you sure you want to delete this category? All menu items within it will also be permanently deleted.</p>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelector('.content-header h1').textContent = 'Menu Categories';
    ...
    const CategoriesApp = {
        ...
        async loadCategories() {
            try {
                const response = await fetch('ajax/ajax_handler_categories.php?action=fetchAll');
        ...
        render() {
            ...
            const filtered = this.state.categories.filter(cat => 
                ...
                (cat.Description && cat.Description.toLowerCase().includes(this.state.searchTerm))
            );
        ...
        createCategoryCard(cat) {
            return `
                <div class="category-card" data-id="${cat.CategoryID}">
                    ...
                    <div class="card-body">
                        <p>${this.escapeHTML(cat.Description) || 'No description provided.'}</p>
                    </div>
        ...
        async handleFormSubmit(event) {
            ...
            try {
                const response = await fetch('ajax/ajax_handler_categories.php', { method: 'POST', body: formData });
                const data = await response.json();
                if (data.success) {
                    this.closeDrawer();
        ...
        async executeDelete() {
            ...
            try {
                const response = await fetch('ajax/ajax_handler_categories.php', {
                    method: 'POST',
